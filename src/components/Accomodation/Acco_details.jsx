const details = [
  {
    ...
    content: [
      {
        id: "1",
        subheading: "ACCOMMODATION CHARGES",
        subcontent: "Yet to be declared",
      },

      { id: "2", subheading: "TIMING:", subcontent: "Yet to be declared" },

      {
        id: "3",
        subheading: "CANCELLATIO POLICY:",
        subcontent:
          "Any queries regarding Cancellation or Refund shall be emailed to accommodation@springfest.in . The subject of the email should be 'Cancellation of Accom- modation'. For any cancellations before the deadline, 75% of the total amount shall be refunded within 10 working days after the festival; there shall be no refunds for cancellations after the deadline. Deadline of cancellation: 20th January 2024.",
      },
      {
        id: "4",
        subheading: "ok",
        subcontent:
         "See you here at Spring Fest 2024 Regards, Team Spring Fest "},
    ],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    content: [
      {
        id: "1",
        subheading: "How to avail accommodation?",
        subcontent:
          "1. Go to the URL and fill in the registration form. \n2. Complete the payment procedure.\n 3. Report at the accommodation desk(during fest)",
      },
      {
        id: "2",
        subheading: "What is the payment procedure?",
        subcontent:
          "The payment procedure will be online. The accommodation charges are provided under the tab Accommodation Charges on the hospitality page. You will have to report at the accommodation desk near the Old Computer Science Building with the email printout. Failing to bring any of the documents may lead to the cancellation of your accommodation.",
      },
      {
        id: "3",
      ...
      {
        id: "5",
        subheading: "Shall I carry my ID card with me?",
        subcontent:
          "All guest participants must carry college IDs. This is for your convenience. Moreover, you will be asked to show your college ID cards at the time of allotment of rooms in the hostels.",
      },
      {
        id: "6",
        subheading:
      ...
      },
      {
        ...
        subcontent:
          "For all our guests and participants we will set up a huge food court serving a variety of cuisines satisfying the needs of every palette. In addition, you can also eat in the many canteens, and restaurants inside the campus.",
      },
      {
        id: "11",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        id: "6",
        subcontent:
          "Accommodation tent will be closed during the time of Starnights i.e. from 6pm to 11pm on all days from 26th-29th January 2024. No calls/requests to provide accommodation can be entertained at this time. However, if during this time, you enter the campus, you may wait in the Old Badminton Court at Gymkhana.",
      },
      {
        id: "7",
        subcontent:
      ...
      },
      {
        id: "24",
        subcontent:
          "All rooms have to be vacated by 30th January 2024 strictly by 2pm.",
      },
